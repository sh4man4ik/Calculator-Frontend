...
function button2() {
    let input = document.getElementById("input").value;
    if (document.getElementById("input").value == "Error" || document.getElementById("input").value == "Infinity") {
        let input = document.getElementById("input").value = "";
    } else {
...
function smooth() {
    ...
    try {
        ...
        let inputNumber = eval(inputValue);
            ...
            if (inputNumber.toString().split(".")[1]?.length >= 8) {
                inputNumber = inputNumber.toFixed(8);
            }
